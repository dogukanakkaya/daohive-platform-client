...
export type GetContractDetailQuery = { __typename?: 'Query', contract: { __typename?: 'Contract', name: string, voters: Array<{ __typename?: 'PairedVoter', address: string, name: string | null }> } };
