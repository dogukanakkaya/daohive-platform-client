...
export type ContractInput = {
  ...
  voterGroupId: InputMaybe<Scalars['String']['input']>;
};
...
export type DeployContractMutation = { __typename?: 'Mutation', deploy: { __typename?: 'Contract', address: string } };
